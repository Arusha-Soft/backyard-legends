        ...
        public static void ApplyPreset(UiJuiceAnimator.JuiceElement e, UiJuiceAnimator.FeelingPreset feeling, float durationMin, float durationMax)
        {
            ...
            switch (feeling)
            {
                ...
                case UiJuiceAnimator.FeelingPreset.Slow:
                    ...
                    e.ease = JuiceMath.GetPreset(JuiceMath.CurvePreset.EaseInOutSine);
                    break;
                ...
                case UiJuiceAnimator.FeelingPreset.Bounce:
                    ...
                    e.ease = JuiceMath.GetPreset(JuiceMath.CurvePreset.EaseOutBounce);
                    e.useCurvePath = true;
                ...
                case UiJuiceAnimator.FeelingPreset.Gentle:
                    ...
                    e.delay = Random.Range(0f, 0.12f);
                    e.ease = JuiceMath.GetPreset(JuiceMath.CurvePreset.EaseInOutCubic);
                    break;
                ...
                case UiJuiceAnimator.FeelingPreset.Snappy:
                    ...
                    e.ease = JuiceMath.GetPreset(JuiceMath.CurvePreset.EaseOutCubic);
                    e.useCurvePath = false;
                    e.curveAmplitude = 0f;
                    break;
                ...
                case UiJuiceAnimator.FeelingPreset.SoftRise:
                    ...
                    e.delay = Random.Range(0f, 0.1f);
                    e.ease = JuiceMath.GetPreset(JuiceMath.CurvePreset.EaseOutSine);
                    e.useCurvePath = true;
                ...
                case UiJuiceAnimator.FeelingPreset.Ripple:
                    ...
                    e.duration = RD(0.55f, 0.85f, durationMin, durationMax);
                    e.delay = Random.Range(0f, 0.12f);
                    e.ease = JuiceMath.GetPreset(JuiceMath.CurvePreset.EaseInOutCirc);
                    e.useCurvePath = true;
                ...
                case UiJuiceAnimator.FeelingPreset.Cascade:
                    ...
                    e.ease = JuiceMath.GetPreset(JuiceMath.CurvePreset.EaseInOutQuart);
                    e.useCurvePath = true;
                    e.curveAmplitude = Random.Range(6f, 14f);
                    break;
                ...
                case UiJuiceAnimator.FeelingPreset.SlideOutTop:
                    e.animatePosition = true;
                    e.positionOffset = new Vector2(Random.Range(-20f, 20f), Random.Range(160f, 240f));
                    e.animateRotation = false;
                    e.rotationOffset = Vector3.zero;
                    e.animateScale = false;
                    e.scaleFrom = Vector3.one;
                ...
                case UiJuiceAnimator.FeelingPreset.SlideOutDown:
                    e.animatePosition = true;
                    e.positionOffset = new Vector2(Random.Range(-20f, 20f), Random.Range(-240f, -160f));
                    e.animateRotation = false;
                    e.rotationOffset = Vector3.zero;
                    e.animateScale = false;
                    e.scaleFrom = Vector3.one;
                ...
                case UiJuiceAnimator.FeelingPreset.SpiralIn:
                    ...
                    e.duration = RD(0.55f, 0.85f, durationMin, durationMax);
                    e.delay = Random.Range(0f, 0.1f);
                    e.ease = JuiceMath.GetPreset(JuiceMath.CurvePreset.EaseOutCirc);
                    e.useCurvePath = true;
